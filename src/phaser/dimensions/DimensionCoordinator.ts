...
import { portalFinishedClosing, syncPortalLifecycle } from './PortalLifecycle';
import { getPortalTransferCommands } from './PortalTransferSystem';
import type { ActiveViewState, DimensionCommand, PortalEntity, SpaceId } from './types';
...
export class DimensionCoordinator {
  ...
  openPortal(portal: PortalEntity): void {
