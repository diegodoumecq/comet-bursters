import type { FireMode } from './fuel';
import type { ProjectileKind, Vector, WeaponKind } from '../model';
import { getFireMode, spendWeaponFuel } from './fuel';
import { FIRE_INTERVAL_MS, PROJECTILES } from './weapons';
