...
export function createLavaPlanetShaderTexture(
  ...
  setFloatUniform(gl, program, 'u_seed', getPlanetSeed(planet));
...
function hexToVec3Uniform(hex: string): Vec3Uniform {
...
function getPlanetSeed(planet: PlanetEntity): number {
