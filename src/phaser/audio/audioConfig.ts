...
export const AUDIO_ASSETS: AudioAsset[] = [
  ...
  { key: AUDIO_KEYS.sfx.weaponFuelGun, urls: ['audio/placeholder/weapon-pusher.wav'] },
...
export const AUDIO_KEY_BUSES: Record<AudioKey, AudioBus> = {
  ...
  [AUDIO_KEYS.sfx.weaponFuelGun]: 'sfx',
...
export const SFX_CUE_CONFIG: Record<SfxKey, SfxCueConfig> = {
  ...
  [AUDIO_KEYS.sfx.weaponFuelGun]: { cooldownMs: 80, maxDistance: 900, volume: 0.5 },
