  ...
  return (
    ...
    >
      <div className="grid grid-cols-2 gap-3">
        {(['player', 'enemy-patroller', 'column', 'refuel-station'] as const).map((entityType) => (
          <button
            key={entityType}
            type="button"
      ...
      <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-4 text-xs text-slate-400">
        ...
        <div className="mt-2">
          Columns are static scene props rendered from their assigned sprite.
        </div>
        <div className="mt-2">Refuel stations refill fuel by proximity through walls.</div>
      </div>
